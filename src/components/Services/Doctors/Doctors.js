...
const Doctors = () => {
    ...
    let isLoggedIn = token ? jwtDecode(token).email : null;
    ...
    return (
        <div id='doctors'>
            {isLoggedIn && doctors[0].length > 1 ? <>
                <Box sx={{ bgcolor: 'rgb(125, 181, 215)', color: 'primary.main', p: 2, mb: 2, mt: 6, textAlign: "center" }}>
                    <Container maxWidth="xl">
                        <Typography sx={{ mt: 10, mb: 2, fontWeight: 600 }} style={{color:"rgb(1,64,118)"}}
                            variant='h5'
                        ...
                        <Grid container spacing={3}>
                            {
                                doctors[0]?.map((doctor, index) => (
                                    <Grid key={index} item xs={12} sm={6} md={4} lg={3} sx={{ mx: 'auto' }}>
                                        <Card sx={{
                                            mx: 'auto',
                                            boxShadow: 10,
                        ...
                        <HashLink smooth to="/home" className='text-style'> <Button variant="contained" startIcon={<HomeIcon />} sx={{ mb: 5, mt: 5, bgcolor: 'rgb(1,64,118)' }} >
                            Back to Home
                        </Button></HashLink>
