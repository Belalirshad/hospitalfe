...
const ServiceDetails = () => {
    ...
    return (
        <Box sx={{ bgcolor:'rgb(125, 181, 215)', color: 'primary.main', p: 2, mb: 2, textAlign: "center" }}>
            <Container maxWidth="xl">
                <Typography sx={{ mt: 5, mb: 2, fontWeight: 600, color:'rgb(1,64,118)' }}
                    variant='h6'
                >Why Choose Our Medical
                </Typography>

                <Typography sx={{ mb: 8, fontWeight: 600, color:'rgb(1,64,118)' }}
                    variant='h5'
                            ...
                            <Grid key={service.id} item xs={12} md={12} lg={12}>
                                ...
                                <Card sx={{
                                    ...
                                    <HashLink smooth to="/appointment" className='text-style'>
                                        <Button sx={{ mt: 2, mb: 2, bgcolor: 'rgb(1,64,118)' }} variant="contained" className="CheckButton">
                                            Make an Appointment
                                            <AddCircleIcon />
                                        </Button>
                                    </HashLink>
                ...
                <HashLink smooth to="/home" className='text-style'> <Button variant="contained" color="primary" startIcon={<HomeIcon />} sx={{ mb: 5, mt: 5, bgcolor: 'rgb(1,64,118)' }}>
                    Back to Home
                </Button></HashLink>
