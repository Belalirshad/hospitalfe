...
const Services = () => {
    ...
    return (
        <Box id='services' sx={{
            ...
            minHeight: '100vh', bgcolor: 'rgb(125, 181, 215)', color: 'primary.main', p: 2, mb: 2, mt: 6, textAlign: "center"
        }}>
            {services[0].length > 1 ?
                <Container maxWidth="xl" >
                    <Typography sx={{ mt:6, mb: 2, fontWeight: 600 }} style={{color:"rgb(1,64,118)"}}
                        variant='h5'
                    >Our Services
                    </Typography>
                                        ...
                                        <CardActions>
                                            ...
                                            <Typography sx={{ mx: 2, p: 2, textAlign: "end" }} >
                                                <Button
                                                    ...
                                                    variant="contained" style={{background:"rgb(1,64,118)"}} startIcon={<ReadMoreIcon />}>
                                                    See More Details...
                                                </Button>
                                            </Typography>
                    ...
                    <HashLink smooth to="/home" className='text-style'> <Button variant="contained" style={{background:"rgb(1,64,118)"}} startIcon={<HomeIcon />} sx={{ mb: 5, mt: 5 }}>
                        Back to Home
                    </Button></HashLink>
