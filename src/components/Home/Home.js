    ...
    return (
        <div id='home'>
            ...
            <Box sx={{ p: 5, mb: 2, alignItems: 'center' }}>
                <Typography sx={{ textAlign: "center" }} variant="h5"> <SubscriptionsIcon sx={{ color: 'rgb(1,64,118)', mr: 1, my: 0.5 }} /> Subscribe for our latest services and details</Typography>
                ...
                <Box sx={{ display: { xs: 'flex-wrap', md: 'flex' }, p: 2, mt: 1, mx: 'auto', minWidth: "70%" }} >
                    ...
                    <Button sx={{transition: '0.5s all ease-in-out', mb: 2, ':hover': {
                                            boxShadow: 1,
                                            backgroundColor: '#CCE5FF'
                                        }}} variant="outlined"  style={{color:"#014076", border:"1px solid #014076"}} onClick={mailSendBtn} startIcon={<SubscriptionsIcon  />} >Subscribe</Button>
                </Box>
            </Box>
        </div>
    );
