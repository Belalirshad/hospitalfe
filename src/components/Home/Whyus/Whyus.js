...
const Whyus = () => {
    ...
    return (
        ...
        <Box sx={{ bgcolor: '#fce4ec', color: 'primary.main', p: 2, mb: 2, textAlign: "center" }} style={{background:"#7db5d7"}}>
            <Container maxWidth="xl">
                ...
                <Typography sx={{ mx: 2, p: 2, textAlign: "end", }} >
                    <HashLink smooth to="/services" className='text-style' color="primary" style={{color:"rgb(1,64,118)"}}>
                        See All services
                    </HashLink>
                </Typography>
