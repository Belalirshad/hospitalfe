    ...
    return (
        <Box sx={{ bgcolor: 'rgb(125,181,215)', color: 'primary.main', p: 2, mb: 2, textAlign: "center" }}>
            <Container maxWidth="xl">
                <Typography sx={{ mt: 2, mb: 2, fontWeight: 600 }} style={{color:"white"}}
                    variant='h6'
                >Meet Our Expert Team
                </Typography>

                <Typography sx={{ mb: 8, fontWeight: 600 }} style={{color:"white"}}
                    variant='h5'
                ...
                <Typography sx={{ mx: 2, p: 2, textAlign: "end", }} >
                    <HashLink smooth to="/doctors" className='text-style' color="primary" style={{color:"rgb(1,64,118)"}}> Meet Our Expert Team </HashLink>
                </Typography>
