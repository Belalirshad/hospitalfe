    ...
    return (
        <Box id='about' sx={{
            ...
            <Container maxWidth="xl">
                <Typography sx={{ color: 'primary.main', mx: 2, my:6, p: 2, textAlign: "center" }} style={{color: "rgb(1,64,118)"}}
                    variant='h4'>
                ...
                <Typography sx={{ mx: 2, p: 2, mb: 4, textAlign: "justify" }}
                    ...
                    Be sure to leave a review on Thakur Hospital of any hospital you’ve visited, whether you’ve had a negative or a positive experience. Share your suggestions about writing hospital reviews in the comments below or message us on facebook.
                    <br /><br /><br />
                </Typography>
